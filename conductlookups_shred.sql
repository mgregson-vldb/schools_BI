...
select cast(json_array_elements(ConductTypes) ->> 'Description' as varchar),
       cast(json_array_elements(ConductTypes) ->> 'DisplayOrder' as varchar),
       cast(json_array_elements(ConductTypes) ->> 'Id' as varchar),
       cast(json_array_elements(ConductTypes) ->> 'LastUpdated' as varchar),
       cast(json_array_elements(ConductTypes) ->> 'LocalId' as varchar),
       cast(json_array_elements(ConductTypes) ->> 'Points' as varchar),
...
select cast(json_array_elements(ConductLookups) ->> 'Code' as varchar),
       ...
       cast(json_array_elements(ConductLookups) ->> 'DisplayOrder' as varchar),
       cast(json_array_elements(ConductLookups) ->> 'Id' as varchar),
       cast(json_array_elements(ConductLookups) ->> 'LastUpdated' as varchar),
       cast(json_array_elements(ConductLookups) ->> 'LocalId' as varchar),
